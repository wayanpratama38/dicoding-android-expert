package com.example.foodist.core.data.source.local

import com.example.foodist.core.data.source.local.entity.MealEntity
import com.example.foodist.core.data.source.local.room.MealDao
